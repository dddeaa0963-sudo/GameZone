...
export const saveSubcategoriesDB = async (data?: any) => { await syncAllDataToDB(); return true; };
export const getSubSubcategoriesDB = async (data?: any) => [];
export const saveSubSubcategoriesDB = async (data?: any) => { await syncAllDataToDB(); return true; };
